...
.SILENT all:
	...
	$(call perform_test,bad_param,"Bad param")
	$(call perform_test,good,"Good")
	$(call perform_test,no_specifier,"No specifier")
	$(call restore_data)
...
generate:
	...
	$(call generate_answers,bad_param)
	$(call generate_answers,good)
	$(call generate_answers,no_specifier)
...
merge:
	...
	$(call merge_test,bad_param)
	$(call merge_test,good)
	$(call merge_test,no_specifier)
